...
export class ChangeDetector {
    ...
    runUpdate(forceRedraw) {
        ...
        if (hasChanges || forceRedraw) {
            ...
            isComponent && this.drawService.predraw();
            this.directiveParser.preparse(isComponent);
            isComponent && this.drawService.postdraw(this.directiveParser.getContextNodes(), node => this.directiveParser.createContext(node));
    ...
    setDefaultLastValue() {
        ...
        setTimeout(() => this.runUpdate(true));
    }
}
