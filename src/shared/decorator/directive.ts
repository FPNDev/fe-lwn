...
const BindMap = new Map<string, { new(element: Element, ...args: any[]): any }>();

export function Bind(decoratorConfig: DirectiveConstructor) {
    return (bindClass: { new(...args: any[]): any }): any => {
...
export function getBind(key: string) {
